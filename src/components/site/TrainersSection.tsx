...
import t1Asset from "@/assets/trainer-pk-1.jpg.asset.json";
import t2 from "@/assets/trainer-2.jpg";
import t3 from "@/assets/trainer-3.jpg";
import t4Asset from "@/assets/zoya-new.jpg.asset.json";

const trainers = [
  { img: t1Asset.url, name: "Ayesha Khan", spec: "Strength & Conditioning", exp: "8 yrs" },
  { img: t2, name: "Sana Malik", spec: "Yoga & Mobility", exp: "6 yrs" },
  { img: t3, name: "Hira Ahmed", spec: "HIIT & Fat Loss", exp: "5 yrs" },
  { img: t4Asset.url, name: "Zoya Iqbal", spec: "Nutrition Coach", exp: "7 yrs" },
];
