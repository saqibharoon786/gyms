...
import i11 from "@/assets/inside-11.jpg.asset.json";
import i12 from "@/assets/inside-12.jpg.asset.json";
import i13 from "@/assets/inside-13.jpg.asset.json";
import i14 from "@/assets/inside-14.jpg.asset.json";
import i15 from "@/assets/inside-15.jpg.asset.json";
import i16 from "@/assets/inside-16.jpg.asset.json";
import i17 from "@/assets/inside-17.jpg.asset.json";
import i18 from "@/assets/inside-18.jpg.asset.json";
import i19 from "@/assets/inside-19.jpg.asset.json";
import i20 from "@/assets/inside-20.jpg.asset.json";
...
const galleryImages = [
  { src: i15.url, cat: "Our Building" },
  { src: i12.url, cat: "Cardio Zone" },
  { src: i13.url, cat: "Dumbbell Rack" },
  { src: i19.url, cat: "Cardio Floor" },
  { src: i16.url, cat: "Free Weights" },
  { src: i17.url, cat: "Boxing Bag" },
  { src: i11.url, cat: "Foam Rollers" },
  { src: i18.url, cat: "Strength Machine" },
  { src: i14.url, cat: "Champion of the Month" },
  { src: i20.url, cat: "Our Members" },
  { src: g5, cat: "Studio" },
  { src: g1, cat: "Cardio" },
  { src: g6, cat: "Cardio" },
  { src: g8, cat: "Studio" },
