import t1 from "@/assets/transform-new-1.jpg.asset.json";
import t2 from "@/assets/transform-new-2.jpg.asset.json";
import t3 from "@/assets/transform-new-3.jpg.asset.json";
import t6 from "@/assets/transform-new-4.jpg.asset.json";

type Item = { img: string; name: string; weeks: number; quote: string };

const items: Item[] = [
  { img: t1.url, name: "Mariam, 28", weeks: 16, quote: "Lost 14kg & gained confidence I never knew I had." },
  { img: t2.url, name: "Sara, 34", weeks: 20, quote: "Postpartum to powerful — PERFECTLY changed my life." },
  { img: t3.url, name: "Aisha, 30", weeks: 36, quote: "From April 2023 to January 2024 — a whole new me." },
  { img: t6.url, name: "Hina, 32", weeks: 52, quote: "January 2023 to 2024 — from dumbbells to deadlifts." },
];
