// Import the images directly (no .asset.json)
import groupLineup from "@/assets/trainer1.png";   
import personalLineup from "@/assets/trainer2.png";   

const items = [
  { img: groupLineup, label: "Group Training Lineup" },  
  { img: personalLineup, label: "Personal Training Lineup" },
];
