  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "neon-pulse": {
          "0%,100%": { boxShadow: "0 0 10px hsl(var(--neon) / 0.3), 0 0 22px hsl(var(--neon) / 0.15)" },
          "50%": { boxShadow: "0 0 16px hsl(var(--neon) / 0.5), 0 0 36px hsl(var(--neon) / 0.25)" },
        },
        "marquee": {
      ...
      animation: {
        ...
        "fade-in-up": "fade-in-up 0.8s cubic-bezier(0.65,0,0.35,1) forwards",
